...
Spenditure is intended to primarily be used on mobile devices in order to emphasize accessibility and allow users to make quick updates as they make purchases. While it is not the most common use case, Spenditure will have a companion website so it can be used on desktop devices as well.
