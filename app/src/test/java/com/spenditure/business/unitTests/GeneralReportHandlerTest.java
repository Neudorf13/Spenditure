...
public class GeneralReportHandlerTest {
    ...
    public void testTotalSpending() {
        ...
        assertEquals("Expected category 1 to have a total spending of ", category1,440.75,0.1);
        assertEquals("Expected category 2 to have a total spending of ",category2,79.185,0.1);
    ...
    public void testAverageSpending() {
        ...
        assertEquals("Expected category 2 to have a average spending of 316.74",category2,316.74,0.1);
        assertEquals("Expected category 3 to have a average spending of 0",category2,0,0.1);
    ...
    public void testCategoryReport() {
        ...
        // testing category 2
        assertEquals("Expected category 2 to have a main category of 1", category2.getCategory().getCategoryID(),1,0.1);
        assertEquals("Expected category 2 to have total spending of 79.185", category2.getTotalSpending(),79.185,0.1);
        assertEquals("Expected category 2 to have num transactions of 4", category2.getNumTransactions(),4,0.1);
        assertEquals("Expected category 2 to have average transactions of 316.74", category2.getAverageTransactions(),316.74,0.1);
        assertEquals("Expected category 2 to have percentage of 19.73", category2.getPercentage(),3.54,0.1);
    }
    ...
    public void testSortByTotal()
    {
        ...
        assertEquals("Testing 2nd position of sort by total", test.get(0).getCategoryID(), 1,0.1);
    }
    ...
    public void testSortByPercent()
    {
        ...
        assertEquals("Testing 2nd position of sort by percent", test.get(0).getCategoryID(), 1,0.1);
    }
    ...
    public void testSortByAverage()
    {
        ...
        assertEquals("Testing 2nd position of sort by average", test.get(0).getCategoryID(), 1,0.1);
    }
