...
public class TransactionHandlerTest {
    ...
    public void testGetByDate() {
        ...
        DateTime testTime = new DateTime(2023, 9, 15, 16, 0,0);
        ...
        for(int i = 0; i < numInsertions; i ++)
            ...
            transactionHandler.addTransaction(new Transaction(-1,  "2024 Honda Civic Type R", new DateTime(2024, 2, 29, 16 + i, 20 + i,0), "Winnipeg Honda", 53280.00, "MSRP", true));
